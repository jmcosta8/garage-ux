...
/**
* Visual Composer Norebro Split Box shortcode
*/
...
function norebro_split_box_func( $atts, $content = '' ) {
	...
	$first_vertical_padding = isset( $first_vertical_padding ) ? NorExtraFilter::string( $first_vertical_padding, 'string', '6%' ) : '6%';
	$first_horizontal_padding = isset( $first_horizontal_padding ) ? NorExtraFilter::string( $first_horizontal_padding, 'string', '7%' ) : '7%';
	$second_vertical_padding = isset( $second_vertical_padding ) ? NorExtraFilter::string( $second_vertical_padding, 'string', '6%' ) : '6%';
	$second_horizontal_padding = isset( $second_horizontal_padding ) ? NorExtraFilter::string( $second_horizontal_padding, 'string', '7%' ) : '7%';
