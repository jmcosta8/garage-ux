...
/**
* Visual Composer Norebro Pricing table shortcode
*/
...
function norebro_pricing_table_func( $atts ) {
	...
	$price = isset( $price ) ? NorExtraFilter::string( $price, 'string', '' ) : '';
	...
	$features_subtitle_typo = isset( $features_subtitle_typo ) ? NorExtraFilter::string( $features_subtitle_typo ) : false;
	...
	$subtitle_color = isset( $subtitle_color ) ? NorExtraFilter::string( $subtitle_color ) : 'brand';
	$description_color = isset( $description_color ) ? NorExtraFilter::string( $description_color ) : false;
	$price_color = isset( $price_color ) ? NorExtraFilter::string( $price_color ) : false;
	...
	if ( isset( $button_link ) ) {
		$button_link = NorExtraParser::VC_link_params( $button_link, array( 'caption' => __( 'Read more', 'norebro-extra' ) ) );
	} else {
		$button_link = NorExtraParser::VC_link_params( '', array( 'caption' => __( 'Read more', 'norebro-extra' ) ) );
	}
	...
	$price_settings = NorExtraParser::VC_color_to_CSS( $price_color, 'color:{{color}};' );
	$price_caption_settings = NorExtraParser::VC_color_to_CSS( $price_caption_color, 'color:{{color}};' );
	...
	$features_disabled_titles_settings = NorExtraParser::VC_color_to_CSS( $features_disabled_titles_color, 'color:{{color}};' );
	...
	NorExtraParser::VC_typo_custom_font( $features_subtitle_typo );
